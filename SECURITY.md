...
| **Web UI localhost-only** | The setup wizard (:8721) and dashboard (:8722) bind 127.0.0.1 exclusively — nothing is exposed to the network; remote access requires an SSH tunnel. The dashboard chat is a fixed command allowlist plus answer-only LLM Q&A; it cannot place trades. |
